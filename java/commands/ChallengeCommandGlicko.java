...
public class ChallengeCommandGlicko {
	...
	public ChallengeCommandGlicko(MessageReceivedEvent evt) {
		super();
	...
	public void challengePlayer() {
		...
		if (objMsg.getContentRaw()
				.equalsIgnoreCase(Ref.prefix + "Challenge" + " <@!" + mentionedUser.conversion() + ">")|| objMsg.getContentRaw()
			...
			if (challAuthorUser.conversion().equals(mentionedUser.conversion())) {
				...
				if (checkIfFighting.checkIfFighting() == true) {
					...
					objMsgCh.sendMessage(objUser.getAsMention() + " Would like to fight you " + " <@"
							...
							+ " Within 5 minutes to accept!").queue();
	...
	public void acceptChallenge() {
		...
		if (objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "accept" + " <@" + mentionedUser.conversion() + ">")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "accept" + " <@!" + mentionedUser.conversion() + ">")) {
	...
	public void finishChallWon() {
		if (objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@" + authorChallUser + ">" + " won 2-1")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@!" + authorChallUser + ">" + " won 2-1")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@" + authorChallUser + ">" + " won 2-0")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@!" + authorChallUser + ">" + " won 2-0")) {
			
			//set the number of losses that occurred in the game
			String message = objMsg.getContentRaw();
			int lossCount = Integer.parseInt(message.substring(message.length() - 1)); 
			update.updateScoreClaim(authorUser.conversion(), lossCount);
			...
			if (check.checkMatchCreated(authorUser.conversion(), authorChallUser)) {
				objMsgCh.sendMessage(" GG's\n" + "<@" + authorChallUser + ">" + " Did"
						+ " you really win? \n Reply with \"" + Ref.prefix + "yes @yourName won 2-1 or 2-0\" if you did").queue();
			} else {
	...
	public void finishAuthorWon() {
		...
		if (objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@" + authorUser.conversion() + ">" + " won 2-0")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@" + authorUser.conversion() + ">" + " won 2-1") ||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@!" + authorUser.conversion() + ">" + " won 2-0") ||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + " <@!" + authorUser.conversion() + ">" + " won 2-1")) {
			...
			if (check.checkMatchCreated(authorUser.conversion(), authorChallUser)) {
				objMsgCh.sendMessage(
						" GG's\n" + "<@" + authorChallUser + ">" + " Did" + "<@" + mentionedUser.conversion() + ">"
								+ " really win? \n Reply with \"" + Ref.prefix + "yes @TheirName won 2-0 or 2-1\" if they did")
						.queue();
			} else {
	...
	public void challWonResponse() {
		...
		if (objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@" + authorChallUser + ">" + " won 2-1")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@" + authorChallUser + ">" + " won 2-0") ||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@!" + authorChallUser + ">" + " won 2-1")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@!" + authorChallUser + ">" + " won 2-0")) {
			if (check.checkIfFighting(authorUser.conversion()) == true) {
				...
				//setting the author of the reply to say they lost the game
				update.calimLoss(authorUser.conversion());
				
				//cheching the claims of both users and if they match up distributes points
				if (check.checkClaims(authorUser.conversion(), authorChallUser) == true) {
					...
					points.GlickoUpdate(authorChallUser, authorUser.conversion(), lossCount);
	...
	public void authorWonResponse() {
		...
		if (objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@" + authorUser.conversion() + ">" + " won 2-1")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@" + authorUser.conversion() + ">" + " won 2-0")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@!" + authorUser.conversion() + ">" + " won 2-1")||
				objMsg.getContentRaw().equalsIgnoreCase(Ref.prefix + "yes " + "<@!" + authorUser.conversion() + ">" + " won 2-0")) {
			...
			if (check.checkIfFighting(authorUser.conversion()) == true) {
				...
				//set the author of this message to say they won
				update.calimWin(authorUser.conversion());
				
				//checking if all the claims match up and awarding points if they do
				if (check.checkClaims(authorUser.conversion(), authorChallUser) == true) {
					objMsgCh.sendMessage(objUser.getAsMention() + " Points awarded").queue();
					points.GlickoUpdate(authorUser.conversion(), authorChallUser, lossCount);
